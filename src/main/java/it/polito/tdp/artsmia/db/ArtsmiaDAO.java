...
public List<Adiacenza> getAdiacenze() {
		...
		String sql = "SELECT e1.object_id as id1, e2.object_id as id2, COUNT(*) AS peso FROM exhibition_objects e1, exhibition_objects e2 WHERE e1.exhibition_id = e2.exhibition_id AND "
